...
do
  ...
  java emmarun -r xml -cp $CLASSPATH:/home/cmc/projects/priest/subjectapps/DurboDax/bin -ix +durbodax* org.junit.runner.JUnitCore durbodax.commands.customer.$filename
